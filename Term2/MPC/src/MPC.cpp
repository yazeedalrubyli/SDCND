...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars) {
        /*
         1.`fg` a vector of the cost constraints
         2.`vars` is a vector of variable values (state & actuators)
         3. Reference State Cost.
         4. Define the cost related the reference state and any anything you think may be beneficial.
        ...
        /*
         1. Setup Constraints
         2. Add 1 to each of the starting indices due to cost being located at index 0 of `fg`.
         NOTE: This bumps up the position of all the other values.
         */
        ...
        for (int t = 1; t < N; t++) {
            ...
            AD<double> delta = vars[delta_psi_start + t - 1];
            ...
            if (t > 1) {
                a = vars[a_start + t - 2];
                delta = vars[delta_psi_start + t - 2];
            }
